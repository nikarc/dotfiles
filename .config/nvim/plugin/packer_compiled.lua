...
_G.packer_plugins = {
  ...
  ["dim.lua"] = {
    loaded = true,
    path = "/home/nick/.local/share/nvim/site/pack/packer/start/dim.lua",
  ...
  ["lsp_lines.nvim"] = {
    loaded = true,
    path = "/home/nick/.local/share/nvim/site/pack/packer/start/lsp_lines.nvim",
  ...
  ["lua-dev.nvim"] = {
    loaded = true,
    path = "/home/nick/.local/share/nvim/site/pack/packer/start/lua-dev.nvim",
  ...
  ["octo.nvim"] = {
    ...
    loaded = true,
    path = "/home/nick/.local/share/nvim/site/pack/packer/start/octo.nvim",
  ...
  ["suda.vim"] = {
    loaded = true,
    path = "/home/nick/.local/share/nvim/site/pack/packer/start/suda.vim",
  ...
  ["vim-dadbod"] = {
    loaded = true,
    path = "/home/nick/.local/share/nvim/site/pack/packer/start/vim-dadbod",
