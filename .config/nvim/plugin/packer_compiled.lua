...
_G.packer_plugins = {
  ...
  ["emmet-vim"] = {
    loaded = true,
    path = "/Users/nick/.local/share/nvim/site/pack/packer/start/emmet-vim",
  ...
  ["nvim-colorizer.lua"] = {
    ...
    loaded = true,
    path = "/Users/nick/.local/share/nvim/site/pack/packer/start/nvim-colorizer.lua",
  ...
  ["renamer.nvim"] = {
    loaded = true,
    path = "/Users/nick/.local/share/nvim/site/pack/packer/start/renamer.nvim",
  ...
  ["tokyonight.nvim"] = {
    loaded = true,
    path = "/Users/nick/.local/share/nvim/site/pack/packer/start/tokyonight.nvim",
  ...
  ["vista.vim"] = {
    loaded = true,
    path = "/Users/nick/.local/share/nvim/site/pack/packer/start/vista.vim",
